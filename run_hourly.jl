...
# TODO warum keine saisonalen speicher und dafür lss? => teste mal ohne gasnachfrage
# TODO ohne gas kein lss, aber immer noch kein speicher, außerdem sehr kleiner effekt

# TODO finde ursprung kostenunterschied und vermeide das
# 1) fixe use für biomass, damit kein unterschied mehr in costTrdBuy
...
model_object = anyModel(["baseData","copper","hourlyTimeSeries"],"results", objName = "copperFirstHour")
...
model_object = anyModel(["baseData","decentral","intermediate","hourlyTimeSeries"],"results", objName = "copperSecondHour")
...
model_object = anyModel(["baseData","decentral","hourlyTimeSeries"],"results", objName = "efficientFirstHour")
