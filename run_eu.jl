...
model_object = anyModel(["baseData","scenarios/copper","conditionalData/lowerEE_DE","timeSeries","conditionalData/" * eePot, "conditionalData/runEU_" * gridExp],"_results", objName = "eu_" * eePot * "_" * gridExp, decommExc  = :decomm);
